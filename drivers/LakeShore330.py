...
class LakeShore330:
    ...
    def SetTerminatingCharacterType(self, term):
        ...
        defined as follows:
            ...
            2 = Line feed (LFEOI)
            3 = No terminating characters – EOI line set with last data
    ...
    def TerminatorQuery(self):
        ...
        Returns: the current terminating character type:
            ...
            1 = Line feed and carriage return (LF)(CREOI)
            2 = Line feed (LFEOI)
            3 = No terminating characters – EOI line set with last
                data byte if enabled (End) 
        """
    ...
    def SetControlChannel(self, channel):
        ...
        cycle (½ second) between these commands so the Model 330
    ...
    def SetSampleChannel(self, channel):
        ...
        update cycle (½ second) before reading the sample data to ensure
        proper reading.
