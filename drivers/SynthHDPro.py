...
class SynthHDPro:
    def __init__(self, time_offset, COM_port):
        ...
        # Loading device state to prevent continuous serial communication for common
        # data; device only knows setpoints, not actual frequency or power levels
    ...
    def SetFrequency(self, frequency, ch="A"):
        ...
        try:
            ...
            self.logging(
                "SynthHDPro warning in SetFrequency() : frequency out of range"
            )
        except Exception as err:
