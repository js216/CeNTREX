...
class KoherasBoostik:
    ...
    def __init__(self, time_offset, COM_port):
        ...
        try:
            ...
            logging.warning(f"KoherasBoostik error in initial connection {err}")
    ...
    def SetCurrentGUI(self, current):
        try:
            ...
            logging.error(
                "KoherasBoostik error in SetCurrentGUI : cannot convert to {0} to float"
                .format(current)
            )
    ...
    def SetCurrentWait(self, current):
        try:
            ...
            logging.error(
                "KoherasBoostik error in SetCurrentWait : cannot convert to float"
            )
            return False
        ...
        if isinstance(current, float):
            ...
            try:
                if float(set_current) != current:
                    logging.warning(
                        f"KoherasBoostik warning in SetCurrent() : {set_current} !="
                        f" {current}"
                    )
            ...
            logging.warning(
                "KoherasBoostik warning in SetCurrent() : supply float for current {0}"
                .format(current)
            )
    ...
    def GetCurrent(self):
        ...
        try:
            ...
            logging.warning("KoherasBoostik warning in GetCurrent() : " + str(e))
            return np.nan
    ...
    def GetInputPower(self):
        ...
        try:
            ...
            logging.warning("KoherasBoostik warning in GetInputPower() : " + str(e))
            return np.nan
        ...
        if isinstance(enable, bool):
            ...
            try:
                if int(enable_return) != int(enable):
                    logging.warning(
                        f"KoherasBoostik warning in SetEmission() : {enable_return} !="
                        f" {int(enable)}"
                    )
            except Exception as e:
                logging.warning(f"KoherasBoostik warning in SetEmission() : {e}")
        else:
    ...
    def GetEmission(self):
        ...
        try:
            ...
            logging.warning(f"KoherasBoostik warning in GetEmission() : {e}")
            return np.nan
    ...
    def GetBoosterTemperature(self):
        ...
        try:
            ...
            logging.warning(f"KoherasBoostik warning in GetBoosterTemperature() : {e}")
            return np.nan
