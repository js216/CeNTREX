...
from big_sky_yag.attributes import Trigger, QSwitchMode, Status
...
class BigSkyYag(BigSkyYagDriver):
    ...
    def status(self) -> bool:
        ...
        return laser_status.interlock & (laser_status.flashlamp == Status.START) & (laser_status.q_switch == Status.START)
